...
(library Library_1
	...
	(compDef "LM3880MFX-1AB_NOPB" (originalName "LM3880MFX-1AB_NOPB") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		...
		(compPin "6" (pinName "FLAG1") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "5" (pinName "FLAG2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		(compPin "4" (pinName "FLAG3") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Bidirectional))
		...
		(attr "Datasheet Link" "http://www.ti.com/lit/gpn/lm3880")
		(attr "Height" "1.45 mm")
	)
