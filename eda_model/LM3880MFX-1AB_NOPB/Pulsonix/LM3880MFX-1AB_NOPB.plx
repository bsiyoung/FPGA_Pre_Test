...
//258183/1636591/2.50/6/3/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "LM3880MFX-1AB_NOPB" (originalName "LM3880MFX-1AB_NOPB")
	...
	(compDef "LM3880MFX-1AB_NOPB" (originalName "LM3880MFX-1AB_NOPB") (compHeader (numPins 6) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "6" (pinName "FLAG1") (partNum 1) (symPinNum 4) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "5" (pinName "FLAG2") (partNum 1) (symPinNum 5) (gateEq 0) (pinEq 0) (pinType Unknown))
		(compPin "4" (pinName "FLAG3") (partNum 1) (symPinNum 6) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "LM3880MFX-1AB_NOPB"))
		...
		(attr "Mouser Part Number" "926-LM3880MFX1ABNOPB")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/LM3880MFX-1AB-NOPB?qs=QbsRYf82W3HDF2qNeDWLVw%3D%3D")
		(attr "Manufacturer_Name" "Texas Instruments")
		(attr "Manufacturer_Part_Number" "LM3880MFX-1AB/NOPB")
		(attr "Description" "3 Rail Simple Power Sequencer with Fixed Time Delay")
		(attr "<Hyperlink>" "http://www.ti.com/lit/gpn/lm3880")
		(attr "<Component Height>" "1.45")
		(attr "<STEP Filename>" "LM3880MFX-1AB_NOPB.stp")
